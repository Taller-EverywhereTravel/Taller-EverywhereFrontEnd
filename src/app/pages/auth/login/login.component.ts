...
export class LoginComponent implements OnInit {
  ...
  onSubmit(): void {
    if (!this.useMocks && this.loginForm.invalid) {
    ...
    const authRequest: AuthRequest = {
      email: this.useMocks ? 'demo@everywhere.test' : this.loginForm.value.username,
      password: this.useMocks ? 'demo' : this.loginForm.value.password
    };
